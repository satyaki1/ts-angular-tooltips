...
(function withAngular(angular) {
  ...
  .directive('tooltips', ['$timeout','$window', '$compile', '$interpolate', '$interval', '$sce', 'tooltipsConfig',
   function manageDirective($timeout,$window, $compile, $interpolate, $interval, $sce, tooltipsConfig) {
...
//            initialized = true;//*
        ...
        $scope.showTooltip = function showTooltip() {
          ...
          if(attr.tooltipFreezeOnHover){//*
            theTooltip.bind("mouseover", function(){//*
                theTooltip.forceShow=true;//*
            });//*
            theTooltip.bind("mouseout", function(){//*
                theTooltip.forceShow=false;//*
                $scope.hideTooltip();//*
                $scope.tooltipMouseOutFn&&$scope.tooltipMouseOutFn();//*
            });//*
          }//*
          $scope.clearTriggers();
